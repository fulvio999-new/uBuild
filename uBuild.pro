...
UBUNTU_TRANSLATION_DOMAIN="ubuild.fulvio"
...
aptest.commands = bash $$PWD/uBuild/tests/autopilot/run
aptest.depends  = sub-uBuild

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/uBuild/tests/unit 
unittest.depends  = sub-uBuild
